import { INumerologyOntologyEntity, INumerologyQualityScoreBreakdown } from './NumerologyKnowledgeTypes';

export class NumerologyQualityEngine {
  public computeQualityScore(entity: INumerologyOntologyEntity): INumerologyQualityScoreBreakdown {
    ...
    if (entity.numberValue !== undefined) completenessScore += 20;
