import { IAstrologyOntologyEntity, IAstrologyQualityScoreBreakdown } from './AstrologyKnowledgeTypes';

export class AstrologyQualityEngine {
  public computeQualityScore(entity: IAstrologyOntologyEntity): IAstrologyQualityScoreBreakdown {
    ...
    if (entity.sanskritName || entity.englishName) completenessScore += 20;
